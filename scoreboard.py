...
class ScoreBoard:
    ...
    def prep_score(self):
        ...
        self.score_image = self.font.render(score_str, True, self.score_color,self.settings.bg_color)
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render(level_str,True,self.score_color,self.settings.bg_color)
